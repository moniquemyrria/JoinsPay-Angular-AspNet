...
namespace JoinsPay_BackService.Data.Migrations
{
    ...
    [Migration("20220206005055_expense_expense_status_expense_type_payment_method_category")]
    partial class expense_expense_status_expense_type_payment_method_category
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JoinsPay_BackService.Models.Expense.ExpenseDTO", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long>("idExpenseCategory")
                        .HasColumnType("bigint");

                    b.Property<long>("idExpenseStatus")
                        .HasColumnType("bigint");

                    b.Property<long>("idExpenseType")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JoinsPay_BackService.Models.Expense.ExpenseStatusDTO", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Expense.Expense_Status");
                });

            modelBuilder.Entity("JoinsPay_BackService.Models.Expense.ExpenseTypeDTO", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Expense.Expense_Type");
                });

            modelBuilder.Entity("JoinsPay_BackService.Models.Expense.Expense_PaymentMethodCategoryDTO", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Expense.Expense_Payment_Method_Category");
                });
            ...
            modelBuilder.Entity("JoinsPay_BackService.Models.Expense.ExpenseDTO", b =>
                {
                    ...
                    b.HasOne("JoinsPay_BackService.Models.Register.ExpenseCategory.ExpenseCategoryDTO", "expenseCategory")
                        .WithMany("Expenses")
                        .HasForeignKey("idExpenseCategory")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JoinsPay_BackService.Models.Expense.ExpenseStatusDTO", "expenseStatus")
                        .WithMany("Expenses")
                        .HasForeignKey("idExpenseStatus")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JoinsPay_BackService.Models.Expense.ExpenseTypeDTO", "expenseType")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("JoinsPay_BackService.Models.Expense.Expense_PaymentMethodCategoryDTO", b =>
                {
                    b.HasOne("JoinsPay_BackService.Models.Expense.ExpenseDTO", "expense")
                        .WithMany("expensePaymentMethodCategories")
